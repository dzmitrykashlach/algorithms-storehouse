...
import com.algorithms.storehouse.tree.commonanchestor.CommonAncestor
import com.algorithms.storehouse.tree.commonanchestor.TreeNode
...
class FindCommonAncestorTest {
    ...
    fun findCommonAncQuadraticTest() {
        ...
        val commonAnc = CommonAncestor().findQuadratic(root, n1, n9)
    ...
    fun findCommonAncLinearTest() {
        ...
        val n1: TreeNode = root.find(1)!!
        val n9: TreeNode = root.find(9)!!
        val commonAnc = CommonAncestor().findLinear(root, n1, n9)
        assertEquals(5,commonAnc.data)
    }
}