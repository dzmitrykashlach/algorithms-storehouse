...
public class CoderTestApp {
    ...
    public static void main(String[] args) {
        ...
        frame.getContentPane().add(new Label("Source text:", Label.RIGHT));
        frame.getContentPane().add(text);
        frame.getContentPane().add(new Label("Compressed text:", Label.RIGHT));
        frame.getContentPane().add(encoded);
        frame.getContentPane().add(new Label("Decoded text:", Label.RIGHT));
