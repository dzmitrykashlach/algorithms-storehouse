...
@Getter
@Setter
class BellmanFordVertex(private val name: String) : Comparable<BellmanFordVertex> {
    ...
    var predecessor: BellmanFordVertex? = null
    ...
    override fun compareTo(other: BellmanFordVertex): Int {
