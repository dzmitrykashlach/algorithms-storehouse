package com.algorithms.storehouse.graphs.belllmanford
...
//    private val iterations = 0
    ...
    fun calculate(from: BellmanFordVertex, to: BellmanFordVertex, edges: List<Edge>): LinkedList<BellmanFordVertex> {
        from.distance = 0.0
...
//                print out negative cycle
    ...
    fun extractRoute(to: BellmanFordVertex): LinkedList<BellmanFordVertex> {
        val route = LinkedList<BellmanFordVertex>()
        route.add(to)
        var dv = to
